...
export function createMockRuntime(
  ...
  const mockRuntime: MockRuntime = {
    ...
    // Message manager for action handlers
    messageManager: {
 ...
 * Compatible with both custom types (userId) and @elizaos/core types (entityId)
 *
...
export function createMockMemory(
  ...
  const baseMemory = {
    ...
    agentId: "test-agent-id" as UUID,
    // Add userId for compatibility with custom types in this project
    userId: "test-user-id",
    content: {
      text: "Test message",
      source: "test",
 ...
 * Compatible with both custom types and @elizaos/core types
 *
...
export function createMockState(
  ...
  return {
    // Add text property for @elizaos/core State compatibility
